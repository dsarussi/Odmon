    ...
    public class OdmonTestCasesReader : ICaseSource
    {
        ...
        private static OdcanitCase MapRowToCase(Dictionary<string, string?> raw)
        {
            ...
            return new OdcanitCase
            {
                ...
                TikName = GetString(raw, "שם_תיק") ?? string.Empty,
                ClientName = GetString(raw, "שם_לקוח") ?? string.Empty,
                ...
                StatusName = GetString(raw, "סטטוס") ?? string.Empty,
                ...
                ThirdPartyLawyerName = GetString(raw, "עו\"ד_צד_ג"),
